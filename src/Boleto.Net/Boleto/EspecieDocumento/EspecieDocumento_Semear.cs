...
namespace BoletoNet
{
    ...
    public enum EnumEspecieDocumento_Semear
    {
        DuplicataMercantil,
        NotaPromissoria,
        NotaSeguro,
    ...
    public class EspecieDocumento_Semear : AbstractEspecieDocumento, IEspecieDocumento
    {
        #region Construtores

        public EspecieDocumento_Semear()
        {
            try
            {
            }
        ...
        public EspecieDocumento_Semear(string codigo)
        {
            try
            {
